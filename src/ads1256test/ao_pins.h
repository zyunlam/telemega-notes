...
#define AO_ADS1256_SPI_CS_PORT        (&stm_gpiob)
#define AO_ADS1256_SPI_CS_PIN         6
#define AO_ADS1256_SPI_CS_MASK        (1 << AO_ADS1256_SPI_CS_PIN)
#define AO_ADS1256_SPI_BUS            (AO_SPI_2_PB13_PB14_PB15 | AO_SPI_MODE_1)
#define AO_ADS1256_SPI_SPEED          AO_SPI_SPEED_2MHz

#define AO_ADS1256_DRDY_PORT          (&stm_gpiob)
#define AO_ADS1256_DRDY_PIN           7

#define AO_ADS1256_CHANNELS           4       /* how many inputs in use */
