...
#define AO_CC1120_SPI_CS_PORT	(&stm_gpiod)
#define AO_CC1120_SPI_CS_PIN	0
#define AO_CC1120_SPI_BUS	AO_SPI_2_PD1_PD3_PD4
#define AO_CC1120_SPI		stm_spi2

#define AO_CC1120_INT_PORT		(&stm_gpioc)
#define AO_CC1120_INT_PIN		(15)
#define AO_CC1120_MCU_WAKEUP_PORT	(&stm_gpiod)
#define AO_CC1120_MCU_WAKEUP_PIN	(2)
